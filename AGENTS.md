...
| [GitHub Operations](.agents/skills/github-operations/SKILL.md) | Reading from or writing to the code-hosting platform (issues, pull requests, comments, labels, reviews, branches) through a proxy-mediated operator identity: sanctioned tool channel, agent-comment markers, the issue-vs-pull-request target gotcha, and untrusted-content handling |
...
| [Product Requirement Guidelines](.agents/skills/product-requirement-guidelines/SKILL.md) | Writing, refining, or reviewing a product requirement, feature spec, or issue description; framing problem/scope/non-goals; writing testable acceptance criteria; framing a spec's UI design or architecture-overview sections |
