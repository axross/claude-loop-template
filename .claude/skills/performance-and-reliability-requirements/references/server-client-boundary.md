...
Apply these rules to verify that server/client composition (where Next.js (App Router) distinguishes a server tier from a client tier) does not create avoidable latency or ship unnecessary client code.
