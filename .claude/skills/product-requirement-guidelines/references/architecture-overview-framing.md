...
- SHOULD apply a concrete trigger test before writing the section: is this decision hard or costly to reverse, does it affect more than one module or team, would a future engineer need to know _why_ this shape was chosen? Omit the section if none apply.
